...
var ConsoleLogViewer = (function() {
	...
	ConsoleLogViewer.prototype.addCSS = function()
	{
		...
		css += '#debug_console a.log-button {font: bold 12px sans-serif!important; pointer-events:all; text-align:center; text-decoration:none; color:#a6a6a6; width:16px; height:12px; padding:5px; margin:1px; display:block; float:right; box-sizing: content-box; }';
